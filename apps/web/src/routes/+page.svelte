...
<section class="hero">
	...
	<div class="prose">
		...
		<p>
			...
			things are meant to be shared with you and your community for a better digital well-being.
		</p>

		<p>
			I hope that you find that these things are indeed helpful, and if so, please do share them
			with your friends!
		</p>
